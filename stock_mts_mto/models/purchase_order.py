...
class ProductionSaleOrder(models.Model):
    ...
    _description = 'Production Sale Order'

    sale_order_id = fields.Many2one('sale.order', 'Sale Order', copy=False)
    production_id = fields.Many2one('mrp.production', 'MO', copy=False)
...
class MrpProduction(models.Model):
    ...
    sale_production_id = fields.Many2one('sale.order', string="Source Document", copy=False)
