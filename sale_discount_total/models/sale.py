...
class SaleOrder(models.Model):
    ...
    def supply_rate(self):
        for order in self:
            if order.discount_method == 'global':
                if order.discount_type == 'percent':
                    ...
                    if order.discount_rate and total:
...
class SaleOrderLine(models.Model):
    ...
    @api.onchange('discount_type', 'discount_rate', 'price_unit', 'product_uom_qty')
    def supply_rate(self):
        if self.order_id.discount_method == 'line':
